				...
				<div class="fullscreenmenu__module" trigger="#fs-button">
					...
					<nav class="overlay-menu">
						...
						<ul class="wil-menu-list">
							...
							<li class="current-menu-item"><a href="{{ url('/blog') }}">Blog</a>
							</li>
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/807034/pexels-photo-807034.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
													<div class="post__meta"><span class="date">Nov 26, 2017</span><span class="author"><a href="#">by Maria Gutierrez</a></span></div>
													<h2 class="post__title"><a href="{{ url('/blog-detail') }}">Is UX Really That Important?</a></h2>
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/609687/pexels-photo-609687.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
													<div class="post__meta"><span class="date">Nov 26, 2017</span><span class="author"><a href="#">by Bryan Ryan</a></span></div>
													<h2 class="post__title"><a href="{{ url('/blog-detail') }}">Free Sketch Plugins</a></h2>
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/754949/pexels-photo-754949.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
													<div class="post__meta"><span class="date">Dec 20, 2017</span><span class="author"><a href="#">by Bruce Powell</a></span></div>
													<h2 class="post__title"><a href="{{ url('/blog-detail') }}">3 Essential Design Trends</a></h2>
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/794578/pexels-photo-794578.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
													<div class="post__meta"><span class="date">Dec 20, 2017</span><span class="author"><a href="#">by Sean Coleman</a></span></div>
													<h2 class="post__title"><a href="{{ url('/blog-detail') }}">How to Create and Manage SVG Sprites</a></h2>
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/38069/pexels-photo-38069.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/290386/pexels-photo-290386.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/792906/pexels-photo-792906.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
													<div class="post__meta"><span class="date">Jan 28, 2018</span><span class="author"><a href="#">by Ann Fowler</a></span></div>
													<h2 class="post__title"><a href="{{ url('/blog-detail') }}">Getting Started with Vue.Js</a></h2>
								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- post -->
											<div class="post">
												<div class="post__media"><a href="{{ url('/blog-detail') }}"><img src="https://images.pexels.com/photos/789140/pexels-photo-789140.jpeg?h=350&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<div class="post__body">
													<div class="post__meta"><span class="date">Dec 20, 2017</span><span class="author"><a href="#">by Olivia Ryan</a></span></div>
													<h2 class="post__title"><a href="{{ url('/blog-detail') }}">Design a Perfect Homepage</a></h2>
													<p class="post__text">Maecenas lorem ex, euismod eget pulvinar non, facilisis ut leo. Quisque placerat purus in neque efficitur ornare. Nam at justo mag</p>
													<a class="md-btn md-btn--outline-primary" href="#">read more
													</a>
												</div>
