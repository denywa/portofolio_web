				...
				<div class="fullscreenmenu__module" trigger="#fs-button">
					...
					<nav class="overlay-menu">
						...
						<ul class="wil-menu-list">
							...
							<li class="current-menu-item"><a href="{{ url('/work') }}">Work</a>
							</li>
				...
				<section class="awe-section">
					<div class="container">
						...
						<div class="page-title pb-40">
							...
							<p class="page-title__text">Explore my projects and creations that showcase my skills and passion for technology. </p>
